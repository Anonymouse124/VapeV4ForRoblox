if shared.VapeExecuted then
	...
	local function GetURL(scripturl)
		if shared.VapeDeveloper then
			...
			local res = game:HttpGet("https://raw.githubusercontent.com/Anonymouse124/VapeV4ForRoblox/main/"..scripturl, true)
	...
	local function getcustomassetfunc(path)
		if not betterisfile(path) then
			...
			local req = requestfunc({
				Url = "https://raw.githubusercontent.com/PGN/VapeV4ForRoblox/main/"..path:gsub("vape/assets", "assets"),
				Method = "GET"
			})
